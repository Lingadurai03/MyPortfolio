...
const WorkExperience = () => {
    return (
        <section
            id='experience'
            className='max-w-[800px] mx-auto sm:mt-20 px-5 sm:px-10 py-5 sm:py-8 border border-l-white/10 border-t-white/10 border-b-0 border-r-0 gap-5 sm:gap-10 rounded-lg bg-white/3 backdrop-blur z-10 group'
        >
            <div className='text-center'>
                <Heading> Work Experience</Heading>
            </div>
            <div className='relative border-l border-gray-300 max-w-3xl mx-auto pl-6'>
                <div className='mb-10'>
                    ...
                    <ul className='list-disc list-inside mt-3 text-white space-y-1'>
                        ...
                        <li>
                            ...
                            and{' '}
                            <span className='font-semibold'>OTP handling</span>
                        </li>
                        <li>
                            Followed{' '}
                            <span className='font-semibold'>
